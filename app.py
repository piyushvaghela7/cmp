...
**App built:**  in `Python` + `Streamlit` by [Piyush Vaghela](https://instagram.com/ipiyushvaghela) 

---
''')

# accept zip file which contain excel files
...
if st.sidebar.button('Submit'):
    ...
    if uploaded_file == None:
        ...
        st.info('Please drag and drop properly ; )')
    else:
        ...
        st.info('Thanks for visit. [075 10K 10010]')
else:
    st.info('Awaiting for ZIP file to be uploaded.')
